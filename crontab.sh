...
11 1,8,13,16,21 * * * bash -c "exec 1<>/proc/1/fd/1; exec 2<>/proc/1/fd/2; set -o allexport; source /overall; source /env; source /cookies; ts-node /scripts/jd_health.ts > /logs/jd_health.ts.log 2>&1 | sed 's/^/ 【健康社区】/'; "
